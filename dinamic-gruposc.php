...
include_once('class/class.billboard.php');  ?>
			<section id="gruposc">
				<header class="title gruposc">
					<div class="wrapper">
						<h1>Grupos de Congregación</h1>
						<div id="nav-menu"></div>
					</div>
				</header>
				<div class="wrapper">
					<div id="gruposc-wrapper">
						<div id="group1">
							<h3 class="groupc-header"><a href="#group1-members">Grupo Nº1</a></h3>
							<div id="group1-members" class="members-list">
								<p class="responsibles">
									<b>Superintendente:</b> Leonel Navarro<br />
									<b>Auxiliar:</b> Germán Demarco
								</p>
								<ul class="list">
									<li class="member-item">Zully Campelo</li>
									...
									<li class="member-item">Erick Garat</li>
									<li class="member-item">Marcelo Paolino</li>
						...
						<div id="group2">
							<h3 class="groupc-header"><a href="#group2-members">Grupo Nº2</a></h3>
							<div id="group2-members" class="members-list">
								...
								<ul class="list">
									...
									<li class="member-item">Shirley de Cabrera</li>
									<li class="member-item">Katherine Cabrera</li>
									<li class="member-item">Vanessa Cabrera</li>
									<li class="member-item">Humberto Cardozo</li>
									<li class="member-item">Janet de Cardozo</li>
									<li class="member-item">Ramiro Ghisolfo</li>
									<li class="member-item">Carla Rodano</li>
									<li class="member-item">Alexa Rodríguez</li>
									<li class="member-item">Elena Rinaldi</li>
						...
						<div id="group3">
							<h3 class="groupc-header"><a href="#group3-members">Grupo Nº3</a></h3>
							<div id="group3-members" class="members-list">
								<p class="responsibles">
									<b>Superintendente:</b> Luis Sandes<br />
									<b>Auxiliar:</b> Ricardo Rodríguez  
								</p>
								<ul class="list">
						...
						<div id="group4">
							...
							<div id="group4-members" class="members-list">
								...
								<ul class="list">
									...
									<li class="member-item">Jennifer de Téliz</li>
									<li class="member-item">Marina Viñoli</li>
								</ul>
							</div>
						</div>
					</div>
			...
			$(document).ready(function(){
				...
				//------------ Grupos de congregación ------------
				$('.groupc-header').click(function(event) {
